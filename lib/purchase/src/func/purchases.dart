...
//     } catch (e) {
//       LogConfig.addLog("${DateTime.now()} : Error completing purchase: $e");
//     }
//   }
...
//           docId: ref.id);
//     } catch (e) {
//       LogConfig.addLog("${DateTime.now()} : Error storing purchase in Firebase: $e");
//     }
//   }
...
//       }
//     } catch (e) {
//       LogConfig.addLog("${DateTime.now()} : Error checking subscription status: $e");
//     }
//     return false;
//   }
...
//       }
//     } catch (e) {
//       LogConfig.addLog("${DateTime.now()} : Error checking baseplan status: $e");
//     }
//     return false;
//   }
