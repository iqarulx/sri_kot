...
class InvoiceDiscountModal extends StatefulWidget {
  final List<InvoiceProductModel> cartDataModel;

  const InvoiceDiscountModal({super.key, required this.cartDataModel});

  @override
  State<InvoiceDiscountModal> createState() => _InvoiceDiscountModalState();
}

class _InvoiceDiscountModalState extends State<InvoiceDiscountModal> {
  @override
            ...
            children: [
              ...widget.cartDataModel.map((product) {
                ...
                return ListTile(
                  ...
                  subtitle: Text(
                      "\u{20B9} ${product.rate!.toStringAsFixed(2)}"), // Original price
                  trailing: Text(
