...
class PrintEnquiryA4 extends StatefulWidget {
  final EstimateDataModel estimateData;
  final ProfileModel companyInfo;
  const PrintEnquiryA4(
      {super.key, required this.estimateData, required this.companyInfo});

  @override
  State<PrintEnquiryA4> createState() => _PrintEnquiryA4State();
}

class _PrintEnquiryA4State extends State<PrintEnquiryA4>
  ...
  format2Pdf() async {
    ...
    var dataResult = await pdf.format2A4();
    setState(() {
      format2 = dataResult;
    });
  }
  ...
  format3Pdf() async {
    ...
    var dataResult = await pdf.format3A4();
    setState(() {
      format3 = dataResult;
    });
  }
