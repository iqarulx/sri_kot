...
class InvoicePDFService {
  ...
  Future<Uint8List> format1A4() async {
    ...
    Map<int, TableColumnWidth> productColumnWidth = commonHsn
        ? {
                  ...
                  pw.TableRow(
                    children: [
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(3),
                        child: pw.Center(
                          child: pw.Text(productList[j][k].hsnCode.toString(),
                              textAlign: pw.TextAlign.center,
                              style: normalTextStyle),
                        ),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(3),
                        child: pw.Center(
                          child: pw.Text(productList[j][k].taxValue.toString(),
                              textAlign: pw.TextAlign.center,
                              style: normalTextStyle),
                        ),
                      ),
                ...
                pw.Container(
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Table(
                        columnWidths: {
                          0: const pw.FlexColumnWidth(10.8),
                      ...
                      if (invoice.taxType ?? false)
                        pw.Table(
                          columnWidths: invoice.sameState ?? false
                              ? {
                          ...
                          children: [
                            ...
                            for (var i in invoice.taxCalc!["tax_details"]
                                ["products"])
                              pw.TableRow(
                                children: [
                                  pw.Padding(
                            ...
                            if (invoice.taxCalc!.containsKey('packing_charges'))
                              pw.TableRow(
                                children: [
                                  pw.Padding(
                                    padding: const pw.EdgeInsets.all(3),
                                    child: pw.Center(
                                      child: pw.Text(
                                          "Charges (${invoice.taxCalc!["packing_charges"]["packing_charges"]})",
                                          textAlign: pw.TextAlign.center,
                                          style: normalTextStyle),
                                    ),
                                  ),
                                  ...
                                  pw.Padding(
                                    ...
                                    child: pw.Center(
                                      child: pw.Text(
                                          (invoice.taxCalc!["packing_charges"]
                                                  ["charges_tax"])
                                              .toStringAsFixed(2),
                                          textAlign: pw.TextAlign.center,
                                          style: normalTextStyle),
                                  ...
                                  child: pw.RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text:
                                              "${AmountToWords().convertAmountToWords((invoice.taxCalc!["tax_details"]["total_tax"]))} Only",
                                          style: TextStyle(
                                            fontSize: 8,
                                            fontWeight: pw.FontWeight.normal,
                                          ),
                                ...
                                pw.Padding(
                                  ...
                                  child: pw.Column(
                                    ...
                                    children: [
                                      ...
                                      pw.SizedBox(height: 5),
                                      pw.Text(
                                        "We are not responsible for any loss, damage, Shortage or pilferage during transit.\nIncase of any such loss, the buyers have to obtain proper certificates from careers\nwithin 21 days from the date of invoice and forward the same to us to enable\nto lodge claim with the insurance company",
                                        style: const pw.TextStyle(
                                          fontSize: 8,
                                        ),
                                      ),
  ...
  Future<Uint8List> format2A4() async {
    ...
    final Map<int, TableColumnWidth> columnWidth = invoice.taxType ?? false
        ? {
            0: const pw.FlexColumnWidth(1.3),
            ...
            return pw.Column(
              ...
              children: [
                ...
                context.pageNumber == 1
                    ...
                    : pw.SizedBox(),
                pw.Table(
                  columnWidths: invoice.taxType ?? false
                      ? {
                          0: const pw.FlexColumnWidth(1.3),
                          1: const pw.FlexColumnWidth(5.5),
                          2: const pw.FlexColumnWidth(1.6),
                    ...
                    children: [
                      ...
                      if (invoice.taxType ?? false)
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(1.5),
                          child: pw.Center(
                            child: pw.Text(productList[j][k].hsnCode ?? '',
                                textAlign: pw.TextAlign.center,
                                style: normalTextStyle),
                          ),
                        ),
                      ...
                      if (invoice.taxType ?? false)
                        pw.Padding(
                          ...
                          child: pw.Center(
                            child: pw.Text(
                                productList[j][k].taxValue.toString(),
                                textAlign: pw.TextAlign.center,
                                style: normalTextStyle),
                          ),
                        ),
                ...
                pw.Container(
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Table(
                        columnWidths: {
                          0: const pw.FlexColumnWidth(8.8),
...
//************** PDF Functions **********************/
  ...
  int getFooterCount() {
    ...
    for (var i in invoice.taxCalc!["tax_details"]["products"]) {
      footerCount += 1;
    }
    if (invoice.taxCalc!.containsKey('packing_charges')) {
      footerCount += 1;
