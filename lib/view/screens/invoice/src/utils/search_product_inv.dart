...
import 'add_custom_product_inv.dart';

class SearchProductBillingInv extends StatefulWidget {
  final bool isConnected;
  const SearchProductBillingInv({super.key, required this.isConnected});

  @override
  State<SearchProductBillingInv> createState() =>
      _SearchProductBillingInvState();
}

class _SearchProductBillingInvState extends State<SearchProductBillingInv> {
