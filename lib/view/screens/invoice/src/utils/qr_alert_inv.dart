...
class QRAlertProductInv extends StatefulWidget {
  final int count;
  final int index;
  const QRAlertProductInv(
      {super.key, required this.count, required this.index});

  @override
  State<QRAlertProductInv> createState() => _QRAlertProductInvState();
}

class _QRAlertProductInvState extends State<QRAlertProductInv> {
