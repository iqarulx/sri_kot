...
class Termal3InchPDF {
  ...
  void printDemoReceipt(NetworkPrinter printer) async {
    try {
      ...
      printer.text(companyInfo.companyName ?? "",
      ...
      for (int i = 0; i < estimateData.products!.length; i++) {
        printer.row(
          [
            ...
            PosColumn(
              text: estimateData.products![i].qty != null
            ...
            PosColumn(
              text: estimateData.products![i].price != null
                  ? estimateData.products![i].price!.toStringAsFixed(2)
                  : "",
              width: 3,
              styles: const PosStyles(
                align: PosAlign.right,
            ...
            PosColumn(
              text: estimateData.products![i].qty != null &&
                      estimateData.products![i].price != null
                  ? (double.parse(estimateData.products![i].qty.toString()) *
      ...
      printer.hr();
      calculationTableView3Inch(
          printer, "Total", estimateData.price!.total!.toStringAsFixed(2));
  ...
  calculationTableView3Inch(
      NetworkPrinter printer, String title, String value) {
    return printer.row(
      [
        PosColumn(
          text: title,
          ...
          styles: PosStyles(
              align: PosAlign.right,
              bold: title.toLowerCase() == "total" ? true : false),
        ),
        PosColumn(
          text: value,
          width: 3,
